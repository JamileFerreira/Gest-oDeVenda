...
/**
 * Servlet implementation class EditarGrupoBD
 */
@WebServlet("/EditarGrupoBD")
public class EditarGrupoBD extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public EditarGrupoBD() {
        super();
	...
	protected void processoRequisicao(HttpServletRequest request, HttpServletResponse response)
		 ...
		 response.setContentType("text/html;charset=UTF-8");
	        try (PrintWriter out = response.getWriter()) {
	        	...
	        	grupo.setIdGrupo(Integer.parseInt(request.getParameter("id")));
