...
/**
 * Servlet implementation class PreecherTelaExcluirVendaServlet
 */
@WebServlet("/PreecherTelaExcluirVendaServlet")
public class PreecherTelaExcluirVendaServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public PreecherTelaExcluirVendaServlet() {
        super();
	...
	protected void processoRequisição(HttpServletRequest request, HttpServletResponse response)
		 ...
		 response.setContentType("text/html;charset=UTF-8");
	        try (PrintWriter out = response.getWriter()) {
	        	...
	        	RequestDispatcher dispatcher = request.getRequestDispatcher("ExcluirVenda.jsp");
